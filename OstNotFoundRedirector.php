...
namespace OstNotFoundRedirector;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstNotFoundRedirector extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_not_found_redirector.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_not_found_redirector.view_dir', $this->getPath() . '/Resources/views/');
